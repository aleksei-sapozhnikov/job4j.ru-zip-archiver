...
**[2. Как собрать](#2-как-собрать)**

**[3. Примеры использования](#3-примеры-использования)**

[3.1. Архивация проекта](#31-архивация-проекта)

[3.2. Распаковка zip-файла](#32-распаковка-zip-файла)
...
[Наверх](#консольный-zip-архиватор)
